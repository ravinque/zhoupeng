...
export const copy: Record<Lang, Copy> = {
  zh: {
    ...
    videoText: "走进洲鹏标准厂房，了解门墙柜橱的生产流程与设备配置。",
    categoriesEyebrow: "产品体系",
    categoriesTitle: "六大系统，组成完整整屋方案",
    showcaseCaption: "洲鹏定制家居 — 设计 · 生产 · 交付",
    aboutP1:
    ...
    aboutP4:
      "围绕门、墙、柜、橱、五金与配套系统，洲鹏可承接方案深化、生产交付、安装文件与售后支持，帮助项目顺利落地。",
    officeLabel: "办公研发",
    officeValue: "1,500 ㎡",
    ...
    emailBodyGeneral:
      "您好，\n\n我想了解洲鹏门墙柜橱及整屋配套方案，请协助提供产品资料与报价。\n\n谢谢。",
    quoteEmailSubject: "洲鹏项目询价",
    brandName: "洲鹏",
    brandMark: "洲鹏 · ZhouPeng",
    pageTitle: "洲鹏智能家居 — 整屋定制方案",
    projectTypeOptions: [
    ...
    quoteMailHeading: "ZhouPeng / 洲鹏 项目询价",
    quoteMailName: "姓名",
    quoteMailEmail: "邮箱",
    quoteMailCountry: "国家",
    quoteMailPhone: "电话",
  ...
  en: {
    ...
    videoText: "Tour ZhouPeng's standard plant and see how doors, walls, and cabinets are built.",
    categoriesEyebrow: "Product systems",
    categoriesTitle: "Six coordinated systems for a complete home",
    showcaseCaption: "ZhouPeng custom homes — design · production · delivery",
    aboutP1:
    ...
    aboutP4:
      "From doors, wall panels, cabinets, kitchens, hardware, and supporting systems, ZhouPeng delivers integrated design, production, installation files, and after-sales support.",
    ...
    emailBodyGeneral:
      "Hello,\n\nI would like to learn about ZhouPeng door, wall, cabinet, kitchen, and whole-home packages. Please share catalogues and pricing.\n\nThank you.",
    quoteEmailSubject: "ZhouPeng project quote request",
    brandName: "ZhouPeng",
    brandMark: "ZhouPeng · 洲鹏",
    pageTitle: "ZhouPeng Smart Living — Whole-home Custom Solutions",
    projectTypeOptions: [
    ...
    quoteMailHeading: "ZhouPeng Project Quote Request",
    quoteMailName: "Name",
  ...
  ar: {
    ...
    videoText: "تعرف على مصنع ZhouPeng القياسي وخطوط إنتاج الأبواب والجدران والخزائن.",
    categoriesEyebrow: "أنظمة المنتجات",
    categoriesTitle: "ستة أنظمة منسقة لمنزل متكامل",
    showcaseCaption: "ZhouPeng للمنازل المخصصة — تصميم · إنتاج · تسليم",
    aboutP1:
      "تأسست شركة Fujian ZhouPeng Industrial Co., Ltd. عام 2012 في منطقة لي جيا بينغ الصناعية بشانغهانغ، على مساحة 70 مو مع أكثر من 20,000 م² مصنع و1,500 م² مكاتب وبحث.",
    aboutP2:
    ...
    aboutP4:
      "من الأبواب والجدران والخزائن والمطابخ والملحقات، يقدم ZhouPeng تصميما وإنتاجا وملفات تركيب ودعما بعد البيع.",
    ...
    emailBodyGeneral:
      "مرحبا،\n\nأود معرفة المزيد عن حزم ZhouPeng للأبواب والجدران والخزائن والمطابخ. يرجى إرسال الكتالوج والأسعار.\n\nشكرا.",
    quoteEmailSubject: "طلب عرض مشروع ZhouPeng",
    brandName: "ZhouPeng",
    brandMark: "ZhouPeng · 洲鹏",
    pageTitle: "ZhouPeng Smart Living — حلول منزل مخصصة متكاملة",
    projectTypeOptions: [
    ...
    quoteMailHeading: "طلب عرض مشروع ZhouPeng",
    quoteMailName: "الاسم",
