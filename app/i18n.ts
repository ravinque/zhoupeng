...
export const copy: Record<Lang, Copy> = {
  ...
  ar: {
    ...
    companyText:
      "تدعم قاعدة Fujian ZhouPeng Industrial في شانغهانغ، فوجيان مشاريع الأبواب والجدران والخزائن والمطابخ والملحقات، مع فرق تصميم وخدمة للمشاريع المخصصة.",
    ...
    serviceDesk: "مركز خدمة Fujian ZhouPeng Industrial",
    villaQuote: "عرض فيلا",
    dealerPrice: "سعر الوكيل",
    chatPlaceholder: "نوع المشروع، المدينة، المساحة، أو الميزانية...",
    send: "إرسال",
    starterMessage: "مرحبا، هذه خدمة Fujian ZhouPeng Industrial. شارك نوع المشروع والمدينة والمساحة لنجهز مسار العرض.",
    ...
    brandHome: "الصفحة الرئيسية لـ Fujian ZhouPeng Industrial",
    brandSubline: "حياة ذكية",
    primaryNavLabel: "التنقل الرئيسي",
    heroImageAlt: "غرفة معيشة منزل ذكي حديثة مع خزائن مدمجة",
    companyImageAlt: "صورة معدات إنتاج Fujian ZhouPeng Industrial",
    ...
    whatsAppStarter: "مرحبا، هذه خدمة واتساب لدى Fujian ZhouPeng Industrial. شارك نوع المشروع والمدينة والمساحة لنجهز عرض السعر.",
    ...
    videoText: "تعرف على مصنع Fujian ZhouPeng Industrial القياسي وخطوط إنتاج الأبواب والجدران والخزائن.",
    categoriesEyebrow: "أنظمة المنتجات",
    categoriesTitle: "ستة أنظمة منسقة لمنزل متكامل",
    showcaseCaption: "Fujian ZhouPeng Industrial للمنازل المخصصة — تصميم · إنتاج · تسليم",
    aboutP1:
    ...
    aboutP4:
      "من الأبواب والجدران والخزائن والمطابخ والملحقات، يقدم Fujian ZhouPeng Industrial تصميما وإنتاجا وملفات تركيب ودعما بعد البيع.",
    ...
    whatsAppInquiry: "مرحبا، أود الاستفسار عن حلول Fujian ZhouPeng Industrial للمنازل المخصصة. يرجى المساعدة في تقديم عرض.",
    emailSubjectGeneral: "استفسار Fujian ZhouPeng Industrial للمنازل المخصصة",
    emailBodyGeneral:
      "مرحبا،\n\nأود معرفة المزيد عن حزم Fujian ZhouPeng Industrial للأبواب والجدران والخزائن والمطابخ. يرجى إرسال الكتالوج والأسعار.\n\nشكرا.",
    quoteEmailSubject: "طلب عرض مشروع Fujian ZhouPeng Industrial",
    brandName: "Fujian ZhouPeng Industrial",
    brandMark: "Fujian ZhouPeng Industrial · 福建洲鹏实业",
    pageTitle: "Fujian ZhouPeng Industrial — حلول منزل مخصصة متكاملة",
    projectTypeOptions: [
    ...
    quoteMailHeading: "طلب عرض مشروع Fujian ZhouPeng Industrial",
    quoteMailName: "الاسم",
